...
write_rds(msmFit1a, path=here::here("data","models", "uncensored", "model 1a - age sex BMI lncreat SBP.rds"))
...
write_rds(msmFit1a, path=here::here("data","models","uncensored", "model 1b - age sex BMI lncreat SBP.rds"))
...
write_rds(msmFit2, path=here::here("data","models", "uncensored", "model 2 - age sex BMI lncreat SBP.rds"))
...
# log creatinine, weight, and SBP are emission distributions, with CV hospitalisation events included as a transient state  -----------------------------------------------------------------------
...
write_rds(msmFit3, path=here::here("data","models", "uncensored", "model 3 - age sex BMI lncreat SBP.rds"))
